        ...
        else
        {
            ...
            if (Physics.Raycast(fpsCam.transform.position, fpsCam.transform.forward, out hit, range))
            {
                ...
                if (hit.transform.gameObject != null)
                {
                    ...
                    {
                        hit.transform.parent.transform.gameObject.GetComponent<EnnemyManager>().health -= 50;
                        if (hit.transform.parent.transform.gameObject.GetComponent<EnnemyManager>().health <= 0)
                        {
